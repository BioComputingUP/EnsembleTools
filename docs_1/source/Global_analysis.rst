...
To illustrate the output of our functions, we have chosen the analysis of the SH3 protein as an example. The graphs we present are related to the analysis of this protein, comparing three distinct ensembles downloaded directly from the Protein Ensemble Database (PED): PED00156e001, PED00157e001, and PED00158e001. These ensembles represent structural states of the N-terminal SH3 domain of the Drk protein (residues 1-59) in its unfolded form, generated with different approaches to generate pools of conformations.
...
.. code-block:: python
   ...
   # If the argument is not provided, an output directory will be created automatically to a default path (${HOME}/.idpet/data
...
*"x_ticks_rotation": The rotation angle of the x-axis tick labels for the violin plot. Default is 45.*

*"summary_stat": Specifies whether to display the “mean”, “median”, or “both” as reference lines on the plots. This applies when violin_plot is True or when multiple_hist_ax is True for histograms.*

*"color": Color of the violin plot. Default is lightblue..*
...
.. code-block:: python
    ...
    vis.radius_of_gyration(violin_plot=True, summary_stat='median', x_ticks_rotation=0)



.. image:: _static/images/sh3/global_analysis/r_of_g.png 
   :align: center
...
.. image:: _static/images/sh3/global_analysis/rg.png
   :align: center
...
*"rg_norm":If set to True, normalizes the end-to-end distances based on the average radius of gyration.[The default value is False]*
...
.. code-block:: python
    ...
    vis.end_to_end_distances(violin_plot= True, summary_stat='both', x_ticks_rotation=0)

.. image:: _static/images/sh3/global_analysis/end_to_end.png 
   :align: center
...
.. math::
   ...
   d_{\text{normalized}} = \frac{R_{\text{ee}}}{<Rg>}

Where <Rg> is the mean Radius of Gyration of the trajectory.

.. code-block:: python

    vis.end_to_end_distances(rg_norm=True, violin_plot=True, color='silver', summary_stat='both', x_ticks_rotation=0)

.. image:: _static/images/sh3/global_analysis/end_to_end_norm.png 
   :align: center
...
.. code-block:: python
    ...
    vis.asphericity(violin_plot=True, summary_stat='both')

.. image:: _static/images/sh3/global_analysis/asphericity.png
   :align: center
  
.. code-block:: python

    vis.asphericity(violin_plot=False, summary_stat='both', multiple_hist_ax=True)

.. image:: _static/images/sh3/global_analysis/asphericity1.png
   :align: center
...
.. image:: _static/images/sh3/global_analysis/prolatness.png
   :align: center
...
.. image:: _static/images/sh3/global_analysis/rg_vs_asph.png
   :align: center
...
.. image:: _static/images/sh3/global_analysis/rg_vs_prol.png
   :align: center
...
.. code-block:: python
    ...
    vis.ensemble_sasa(violin_plot=True, summary_stat='both', x_ticks_rotation=0)

.. image:: _static/images/sh3/global_analysis/output.png
   :align: center
...
.. image:: _static/images/sh3/global_analysis/flory.png
   :align: center
   :scale: 60%
...
.. image:: _static/images/sh3/global_analysis/summary.png
   :align: center
